...
let bestFlavor = Object.keys(flavorDistribution).reduce((best, flavor) => {
  return flavorDistribution[flavor] > (flavorDistribution[best] ?? 0)
    ? flavor
    : best;
}, );

console.log("Top flavor:", bestFlavor, "-", flavorDistribution[bestFlavor]);